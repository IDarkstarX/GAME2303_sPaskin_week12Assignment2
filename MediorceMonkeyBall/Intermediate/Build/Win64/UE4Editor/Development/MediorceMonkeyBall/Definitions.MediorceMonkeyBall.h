...
#define UE_PROJECT_NAME MediorceMonkeyBall
#define UE_TARGET_NAME MediorceMonkeyBallEditor
#define UE_MODULE_NAME "MediorceMonkeyBall"
...
#define MEDIORCEMONKEYBALL_API DLLEXPORT
